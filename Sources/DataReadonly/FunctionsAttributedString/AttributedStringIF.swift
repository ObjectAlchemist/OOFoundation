...
public extension AttributedStringIF {
    ...
    convenience init(_ bool: Bool, THEN primary: NSAttributedString, ELSE secondary: NSAttributedString = NSAttributedString(string: "")) {
        self.init(BoolConst(bool), THEN: AttributedStringConst(primary), ELSE: AttributedStringConst(secondary))
    }
    
    convenience init(_ bool: Bool, THEN primary: NSAttributedString, ELSE secondary: OOAttributedString) {
        self.init(BoolConst(bool), THEN: AttributedStringConst(primary), ELSE: secondary)
    }
    
    convenience init(_ bool: Bool, THEN primary: OOAttributedString, ELSE secondary: NSAttributedString = NSAttributedString(string: "")) {
        self.init(BoolConst(bool), THEN: primary, ELSE: AttributedStringConst(secondary))
    }
    
    convenience init(_ bool: OOBool, THEN primary: NSAttributedString, ELSE secondary: NSAttributedString = NSAttributedString(string: "")) {
        self.init(bool, THEN: AttributedStringConst(primary), ELSE: AttributedStringConst(secondary))
    }
    
    convenience init(_ bool: Bool, THEN primary: OOAttributedString, ELSE secondary: OOAttributedString) {
        self.init(BoolConst(bool), THEN: primary, ELSE: secondary)
    }
    
    convenience init(_ bool: OOBool, THEN primary: NSAttributedString, ELSE secondary: OOAttributedString) {
        self.init(bool, THEN: AttributedStringConst(primary), ELSE: secondary)
    }
    
    convenience init(_ bool: OOBool, THEN primary: OOAttributedString, ELSE secondary: NSAttributedString = NSAttributedString(string: "")) {

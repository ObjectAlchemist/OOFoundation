...
public extension DataIF {
    ...
    public convenience init(_ bool: Bool, THEN primary: Data, ELSE secondary: Data = Data()) {
        self.init(BoolConst(bool), THEN: DataConst(primary), ELSE: DataConst(secondary))
    }
    
    public convenience init(_ bool: Bool, THEN primary: Data, ELSE secondary: OOData) {
        self.init(BoolConst(bool), THEN: DataConst(primary), ELSE: secondary)
    }
    
    public convenience init(_ bool: Bool, THEN primary: OOData, ELSE secondary: Data = Data()) {
        self.init(BoolConst(bool), THEN: primary, ELSE: DataConst(secondary))
    }
    
    public convenience init(_ bool: OOBool, THEN primary: Data, ELSE secondary: Data = Data()) {
        self.init(bool, THEN: DataConst(primary), ELSE: DataConst(secondary))
    }
    
    public convenience init(_ bool: Bool, THEN primary: OOData, ELSE secondary: OOData) {
        self.init(BoolConst(bool), THEN: primary, ELSE: secondary)
    }
    
    public convenience init(_ bool: OOBool, THEN primary: Data, ELSE secondary: OOData) {
        self.init(bool, THEN: DataConst(primary), ELSE: secondary)
    }
    
    public convenience init(_ bool: OOBool, THEN primary: OOData, ELSE secondary: Data = Data()) {
